...
void LinkedList::appendNewNode(University* newUniversity) {
...
void LinkedList::insertNodeAt(University* newUniversity, int position) {
...
void LinkedList::displayNodesDetails() {
	if (head == NULL) {
		cout << "The linked list is empty!" << endl;
		return;
	}
